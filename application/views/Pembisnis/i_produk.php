    ...
    <div class="col-lg-12">
        <div class="ibox ">
            ...
            <div class="ibox-content">
                <form method="POST" action="<?= base_url('Pembisnis/i_produk') ?>">
                    <div class="form-group  row"><label class="col-sm-2 col-form-label">Nama Menu</label>
                        <div class="col-sm-10"><input type="text" class="form-control" name="nama_menu"> </div>
                        <?= form_error('nama_menu', '<div class ="com-12"><small class="text-danger">', '</small></div>') ?>
                    </div>

                    <div class="form-group row"><label class="col-sm-2 col-form-label">Harga</label>
                        <div class="col-sm-10"><input type="text" class="form-control" name="harga">
                        </div>
