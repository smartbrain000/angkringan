    ...
    <div class="col-lg-12">
        <div class="ibox ">
            ...
            <div class="ibox-content">
                <form method="POST" action="<?= base_url('Pembisnis/i_dokumentasi') ?>" enctype="multipart/form-data">
                    <div class="form-group row"><label class="col-sm-2 col-form-label">Dokumentasi</label>
                        <div class="col-md-6">
                    ...
                    <div class="form-group row"><label class="col-sm-2 col-form-label">Keterangan</label>
                        <div class="col-sm-10"><input type="text" class="form-control" name="ket">
                        </div>
                        <?= form_error('ket', '<div class ="com-12"><small class="text-danger">', '</small></div>') ?>
                    </div>
